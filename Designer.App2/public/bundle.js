...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(1), __webpack_require__(2), __webpack_require__(4), __webpack_require__(3), __webpack_require__(5), __webpack_require__(6)], __WEBPACK_AMD_DEFINE_RESULT__ = function (exports, _fableCore, _Topnav, _WelcomePage, _FableArch, _FableArch2, _FableArch3) {
	    "use strict";
	
	    exports.__esModule = true;
	    exports.Actions = exports.Model = exports.Page = undefined;
	    exports.init = init;
	    exports.forwardToNav = forwardToNav;
	    ...
	    var Page = exports.Page = function () {
	        ...
	        Page.prototype.Equals = function Equals(other) {
	            return _fableCore.Util.equalsUnions(this, other);
	        };
	
	        Page.prototype.CompareTo = function CompareTo(other) {
	    ...
	    _fableCore.Util.setInterfaces(Page.prototype, ["FSharpUnion", "System.IEquatable", "System.IComparable"], "Designer.App2.Menu.Page");
	
	    var Model = exports.Model = function () {
	        function Model(nav, input, page) {
	    ...
	    _fableCore.Util.setInterfaces(Model.prototype, ["FSharpRecord", "System.IEquatable", "System.IComparable"], "Designer.App2.Menu.Model");
	    ...
	    var Actions = exports.Actions = function () {
	        ...
	        Actions.prototype.Equals = function Equals(other) {
	            return _fableCore.Util.equalsUnions(this, other);
	        };
	
	        Actions.prototype.CompareTo = function CompareTo(other) {
	            return _fableCore.Util.compareUnions(this, other);
	        };
	    ...
	    _fableCore.Util.setInterfaces(Actions.prototype, ["FSharpUnion", "System.IEquatable", "System.IComparable"], "Designer.App2.Menu.Actions");
	
	    function init() {
	        return new Model((0, _Topnav.init)(), "", new Page("WelcomePage", [(0, _WelcomePage.init)()]));
	    }
	
	    function forwardToNav(navMsg, model) {
	        return new Model((0, _Topnav.update)(model.Nav, navMsg), model.Input, model.Page);
	    }
	    ...
	    function update(model, msg) {
	        return msg.Case === "Nav" ? function (model_1) {
	            ...
	            var Input = "welcome";
	            var Page_1 = new Page("WelcomePage", [(0, _WelcomePage.init)()]);
	            return new Model(model.Nav, Input, Page_1);
	        }() : msg.Fields[0].Case === "ShowUserList" ? function () {
	            var Input = "user list";
	            var Page_1 = new Page("UserListPage", []);
	            return new Model(model.Nav, Input, Page_1);
	        }() : msg.Fields[0].Case === "ShowUserDetail" ? function () {
	            var Input = _fableCore.String.fsFormat("user detail %d")(function (x) {
	                return x;
	            })(msg.Fields[0].Fields[0]);
	
	            var Page_1 = new Page("UserDetailPage", [msg.Fields[0].Fields[0]]);
	            return new Model(model.Nav, Input, Page_1);
	        }() : function () {
	            var Input = _fableCore.String.fsFormat("%A")(function (x) {
	                return x;
	            })(function (x) {
	                var tagName = "nav";
	                return function (children) {
	                    return new _FableArch.Types.DomNode("Element", [[tagName, x], children]);
	                };
	            });
	    ...
	    function showPage(model) {
	        return model.Page.Case === "UserListPage" ? function () {
	            var tagName = "div";
	            return function (children) {
	                return new _FableArch.Types.DomNode("Element", [[tagName, new _fableCore.List()], children]);
	            };
	        }()(_fableCore.List.ofArray([new _FableArch.Types.DomNode("Text", ["TODO: user list"])])) : model.Page.Case === "UserDetailPage" ? function () {
	            var tagName = "div";
	            return function (children) {
	                return new _FableArch.Types.DomNode("Element", [[tagName, new _fableCore.List()], children]);
	            };
	        }()(_fableCore.List.ofArray([new _FableArch.Types.DomNode("Text", [_fableCore.String.fsFormat("TODO: user detail %d")(function (x) {
	            return x;
	        })(model.Page.Fields[0])])])) : (0, _FableArch.map)(function (x) {
	            return x;
	        }, (0, _WelcomePage.view)());
	    }
	    ...
	    function view(model) {
	        return function () {
	            ...
	            return new Actions("Nav", [arg0]);
	        }, (0, _Topnav.view)(model.Nav)), new _FableArch.Types.DomNode("VoidElement", [["hr", new _fableCore.List()]]), function () {
	            var tagName = "label";
	            return function (children) {
	                return new _FableArch.Types.DomNode("Element", [[tagName, new _fableCore.List()], children]);
	            };
	        }()(_fableCore.List.ofArray([new _FableArch.Types.DomNode("Text", ["Enter name: "])])), new _FableArch.Types.DomNode("VoidElement", [["input", _fableCore.List.ofArray([new _FableArch.Types.Attribute("EventHandler", [["oninput", function (x) {
	            return new Actions("ChangeInput", [x.target.value]);
	        }]])])]]), new _FableArch.Types.DomNode("VoidElement", [["br", new _fableCore.List()]]), function () {
	            var tagName = "span";
	            return function (children) {
	                return new _FableArch.Types.DomNode("Element", [[tagName, new _fableCore.List()], children]);
	            };
	        }()(_fableCore.List.ofArray([new _FableArch.Types.DomNode("Text", [_fableCore.String.fsFormat("Hello %s")(function (x) {
	            return x;
	        })(model.Input)])])), new _FableArch.Types.DomNode("VoidElement", [["hr", new _fableCore.List()]]), function () {
	            var tagName = "div";
	            return function (children) {
	                return new _FableArch.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([(0, _Topnav.className)("container")])], children]);
	            };
	        }()(_fableCore.List.ofArray([showPage(model)]))]));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(1), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = function (exports, _fableCore, _FableArch) {
	    ...
	    exports.__esModule = true;
	    exports.Actions = exports.Model = undefined;
	    exports.init = init;
	    exports.update = update;
	    ...
	    var Model = exports.Model = function () {
	        function Model(message, dropdownVisible) {
	            _classCallCheck(this, Model);
	    ...
	    _fableCore.Util.setInterfaces(Model.prototype, ["FSharpRecord", "System.IEquatable", "System.IComparable"], "Designer.App2.Topnav.Model");
	    ...
	    _fableCore.Util.setInterfaces(Actions.prototype, ["FSharpUnion", "System.IEquatable", "System.IComparable"], "Designer.App2.Topnav.Actions");
	    ...
	    function update(model, msg) {
	        return msg.Case === "DisplayDropdown" ? function () {
	            var DropdownVisible = true;
	            return new Model(model.Message, DropdownVisible);
	        }() : msg.Case === "HideDropdown" ? function () {
	            var DropdownVisible = false;
	            return new Model(model.Message, DropdownVisible);
	        }() : msg.Case === "ShowWelcomePage" ? new Model("welcome", false) : msg.Case === "ShowUserList" ? new Model("user list", false) : msg.Case === "ShowUserDetail" ? new Model(_fableCore.String.fsFormat("user detail %d")(function (x) {
	            return x;
	        })(msg.Fields[0]), false) : function () {
	            var DropdownVisible = !model.DropdownVisible;
	            return new Model(model.Message, DropdownVisible);
	        }();
	    }
	
	    function className(c) {
	        return new _FableArch.Types.Attribute("Attribute", [["class", c]]);
	    }
	
	    function navbarHeader(model) {
	        return function () {
	            var tagName = "div";
	            return function (children) {
	                return new _FableArch.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([className("navbar-header")])], children]);
	            };
	        }()(_fableCore.List.ofArray([function () {
	            var tagName = "div";
	            return function (children) {
	                return new _FableArch.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([className("navbar-brand")])], children]);
	            };
	        }()(_fableCore.List.ofArray([function () {
	            var tagName = "a";
	            return function (children) {
	                return new _FableArch.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([function () {
	                    var h = function h(e) {
	                        ...
	                        e.preventDefault();
	                        return function (e) {
	                            return new Actions("ShowWelcomePage", []);
	                        }(e);
	                    };
	        ...
	        }()(_fableCore.List.ofArray([new _FableArch.Types.DomNode("Text", ["Demo"])]))]))]));
	    }
	
	    function navItem2(name, handler) {
	        return function () {
	            var tagName = "li";
	            return function (children) {
	                return new _FableArch.Types.DomNode("Element", [[tagName, new _fableCore.List()], children]);
	            ...
	            var tagName = "a";
	            return function (children) {
	                return new _FableArch.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([new _FableArch.Types.Attribute("Attribute", [["href", "#"]]), function () {
	                    var h = function h(e) {
	                        e.stopPropagation();
	                        e.preventDefault();
	                        return handler(e);
	        ...
	        }()(_fableCore.List.ofArray([new _FableArch.Types.DomNode("Text", [name])]))]));
	    }
	    ...
	    function navItem(name) {
	        return function () {
	            ...
	            var tagName = "a";
	            return function (children) {
	                return new _FableArch.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([new _FableArch.Types.Attribute("Attribute", [["href", "#"]])])], children]);
	            };
	        }()(_fableCore.List.ofArray([new _FableArch.Types.DomNode("Text", [name])]))]));
	    }
	
	    function navbarDropdown(model) {
	        return function () {
	            var tagName = "li";
	            return function (children) {
	                return new _FableArch.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([className("dropdown")])], children]);
	            };
	        }()(_fableCore.List.ofArray([function () {
	            var tagName = "a";
	            return function (children) {
	                return new _FableArch.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([new _FableArch.Types.Attribute("Attribute", [["href", "#"]]), className("dropdown-toggle"), function () {
	                    var h = function h(e) {
	                        e.stopPropagation();
	                        e.preventDefault();
	                        return function (e) {
	                            return new Actions("ToggleDropdown", []);
	                        }(e);
	                    };
	        ...
	        }()(_fableCore.List.ofArray([new _FableArch.Types.DomNode("Text", ["Dropdown"])])), function () {
	            var tagName = "ul";
	            return function (children) {
	                return new _FableArch.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([className("dropdown-menu"), new _FableArch.Types.Attribute("Style", [_fableCore.List.ofArray([["display", model.DropdownVisible ? "block" : "none"]])])])], children]);
	            };
	        }()(_fableCore.List.ofArray([navItem2("user list", function (e) {
	            return new Actions("ShowUserList", []);
	        }), navItem2("user detail", function (e) {
	            return new Actions("ShowUserDetail", [32]);
	        }), navItem("bla 1"), navItem("bla 2"), navItem("bla 3")]))]));
	    }
	
	    function navbarBody(model) {
	        return function () {
	            var tagName = "div";
	            return function (children) {
	                return new _FableArch.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([className("collapse navbar-collapse")])], children]);
	            };
	        }()(_fableCore.List.ofArray([function () {
	            var tagName = "ul";
	            return function (children) {
	                return new _FableArch.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([className("nav navbar-nav")])], children]);
	            };
	        }()(_fableCore.List.ofArray([navItem2("foo", function (e) {
	            return new Actions("ShowUserList", []);
	        }), navItem("bar"), navbarDropdown(model)]))]));
	    }
	    ...
	    function view(model) {
	        return function () {
	            var tagName = "nav";
	            return function (children) {
	                return new _FableArch.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([className("navbar navbar-default")])], children]);
	            };
	        }()(_fableCore.List.ofArray([function () {
	            var tagName = "div";
	            return function (children) {
	                return new _FableArch.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([className("container")])], children]);
	            };
	        }()(_fableCore.List.ofArray([navbarHeader(model), navbarBody(model)]))]));
	    }
	}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(3), __webpack_require__(1)], __WEBPACK_AMD_DEFINE_RESULT__ = function (exports, _FableArch, _fableCore) {
	    "use strict";
	    ...
	    function view(model) {
	        return function () {
	            var tagName = "div";
	            return function (children) {
	                return new _FableArch.Types.DomNode("Element", [[tagName, _fableCore.List.ofArray([new _FableArch.Types.Attribute("Attribute", [["class", "jumbotron"]])])], children]);
	            };
	        }()(_fableCore.List.ofArray([function () {
	            var tagName = "h1";
	            return function (children) {
	        ...
	        }()(_fableCore.List.ofArray([new _FableArch.Types.DomNode("Text", ["Welcome"])])), function () {
	            var tagName = "p";
	            return function (children) {
	                return new _FableArch.Types.DomNode("Element", [[tagName, new _fableCore.List()], children]);
	            };
	        }()(_fableCore.List.ofArray([new _FableArch.Types.DomNode("Text", ["This is an empty welcome page"])]))]));
	    }
	}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(1)], __WEBPACK_AMD_DEFINE_RESULT__ = function (exports, _fableCore) {
	    ...
	    var Types = exports.Types = function ($exports) {
	        var ModelChanged = $exports.ModelChanged = function () {
	            ...
	            ModelChanged.prototype.Equals = function Equals(other) {
	                return _fableCore.Util.equalsRecords(this, other);
	            };
	
	            ModelChanged.prototype.CompareTo = function CompareTo(other) {
	                return _fableCore.Util.compareRecords(this, other);
	            };
	        ...
	        _fableCore.Util.setInterfaces(ModelChanged.prototype, ["FSharpRecord", "System.IEquatable", "System.IComparable"], "Fable.Arch.App.Types.ModelChanged");
	
	        var AppEvent = $exports.AppEvent = function () {
	            ...
	            AppEvent.prototype.Equals = function Equals(other) {
	                return _fableCore.Util.equalsUnions(this, other);
	            };
	
	            AppEvent.prototype.CompareTo = function CompareTo(other) {
	                return _fableCore.Util.compareUnions(this, other);
	            };
	        ...
	        _fableCore.Util.setInterfaces(AppEvent.prototype, ["FSharpUnion", "System.IEquatable", "System.IComparable"], "Fable.Arch.App.Types.AppEvent");
	
	        var AppMessage = $exports.AppMessage = function () {
	            ...
	            AppMessage.prototype.Equals = function Equals(other) {
	                return _fableCore.Util.equalsUnions(this, other);
	            };
	
	            AppMessage.prototype.CompareTo = function CompareTo(other) {
	                return _fableCore.Util.compareUnions(this, other);
	            };
	        ...
	        _fableCore.Util.setInterfaces(AppMessage.prototype, ["FSharpUnion", "System.IEquatable", "System.IComparable"], "Fable.Arch.App.Types.AppMessage");
	
	        var Plugin = $exports.Plugin = function Plugin(producer, subscriber) {
	        ...
	        var application = $exports.application = function application(initMessage, handleMessage, handleReplay, configureProducers, createInitApp) {
	            var state = null;
	        ...
	        var handleMessage = $exports.handleMessage = function handleMessage(update, viewFn, post, notifySubs, message, app) {
	            ...
	            return [app_, new _fableCore.List(function () {
	        ...
	        var calculateModelChanges = $exports.calculateModelChanges = function calculateModelChanges(initState, update, actions) {
	            ...
	            return _fableCore.Seq.fold(function (s, a) {
	                return new _fableCore.List(execUpdate(s)(a), s);
	        ...
	        var handleReplay = $exports.handleReplay = function handleReplay(viewFn, updateFn, post, notifySubs, fromModel, actions, app) {
	            ...
	            return [app_, _fableCore.List.ofArray([function () {
	    ...
	    var AppApi = exports.AppApi = function ($exports) {
	        ...
	        var withInstrumentationProducer = function withInstrumentationProducer(p, app) {
	            var Producers = new _fableCore.List(p, app.Producers);
	        ...
	        var withInstrumentationSubscriber = $exports.withInstrumentationSubscriber = function withInstrumentationSubscriber(subscriber, app) {
	            var Subscribers = new _fableCore.List(subscriber, app.Subscribers);
	        ...
	        var configureProducers = $exports.configureProducers = function configureProducers(producers, post) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(1), __webpack_require__(7)], __WEBPACK_AMD_DEFINE_RESULT__ = function (exports, _fableCore, _virtualDom) {
	    "use strict";
	    ...
	    function createTree(handler, tag, attributes, children) {
	        var toAttrs = function toAttrs(attrs) {
	            ...
	            return _fableCore.Util.createObj(elAttributes != null ? new _fableCore.List(elAttributes, props) : props);
	        };
	    ...
	    var RenderState = exports.RenderState = function () {
	        ...
	        RenderState.prototype.Equals = function Equals(other) {
	            return _fableCore.Util.equalsUnions(this, other);
	        };
	
	        RenderState.prototype.CompareTo = function CompareTo(other) {
	            return _fableCore.Util.compareUnions(this, other);
	        };
	    ...
	    var ViewState = exports.ViewState = function () {
	        ...
	        ViewState.prototype.Equals = function Equals(other) {
	            return _fableCore.Util.equalsRecords(this, other);
	        };
	    ...
	    _fableCore.Util.setInterfaces(ViewState.prototype, ["FSharpRecord", "System.IEquatable"], "Fable.Arch.Virtualdom.ViewState");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var diffProps = __webpack_require__(18)
